...
bool DataManager::LoadStrings(const char* file) {
	string str = CCFileUtils::getInstance()->getStringFromFile(file);
	if (str.empty())
		return false;
	...
	//read level info
	str = CCFileUtils::getInstance()->getStringFromFile("levels.json");
	...
	//Read app config
	str = CCFileUtils::getInstance()->getStringFromFile("localconfig.json");
