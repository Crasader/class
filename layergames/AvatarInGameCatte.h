...
#ifndef AvatarInGameCatte_h__
#define AvatarInGameCatte_h__
...
class LayerAvatarInGameCatte : public Layer
{
public:
	LayerAvatarInGameCatte();
	~LayerAvatarInGameCatte();

	virtual bool init();
	CREATE_FUNC(LayerAvatarInGameCatte);
