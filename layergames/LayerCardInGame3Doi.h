...
#ifndef Layer_Card_inGame_3Doi___
#define Layer_Card_inGame_3Doi___
...
class LayerCardInGame3Doi : public Layer
{
public:
	LayerCardInGame3Doi();
	~LayerCardInGame3Doi();
	bool init();
	CREATE_FUNC(LayerCardInGame3Doi);
    ...
    //3Doi
    Point getStartPositionCardUserLeft_Hit_3Doi();
    Point getStartPositionCardUserRight_Hit_3Doi();
    Point getStartPositionCardUserTop_Left_Hit_3Doi();
    Point getStartPositionCardUserTop_Right_Hit_3Doi();
    Point getStartPositionCardUserBot_Hit_3Doi();
    Point getStartPositionCardByPos_3Doi(int pos);
    void actionHitCardBy3Doi(int posUser, vector<int> arrID);
    void reloadCardPos(int pos);
    vector<Card*> arrHitCardOnTableTopLeft;// mang cac quan bai danh ra tren ban danh cho 3Doi
    vector<Card*> arrHitCardOnTableTopRight;// mang cac quan bai danh ra tren ban danh cho 3Doi
    vector<Card*> arrHitCardOnTableLeft;// mang cac quan bai danh ra tren ban danh cho 3Doi
    vector<Card*> arrHitCardOnTableRight;// mang cac quan bai danh ra tren ban danh cho t3Doi
    vector<Card*> arrHitCardOnTableBot;// mang cac quan bai danh ra tren ban danh cho 3Doi
    vector<Card*> arrHitCardOnTableBotRight;// mang cac quan bai danh ra tren ban danh cho 3Doi

    vector<Card*> arrGhepDoiOnTableBot;// mang cac quan bai danh ra tren ban danh cho 3Doi
    vector<Card*> arrGhepDoiOnTableBotRight;// mang cac quan bai danh ra tren ban danh cho 3Doi
    vector<Card*> arrGhepDoiOnTableRight;// mang cac quan bai danh ra tren ban danh cho 3Doi
    vector<Card*> arrGhepDoiOnTableLeft;// mang cac quan bai danh ra tren ban danh cho 3Doi
    vector<Card*> arrGhepDoiOnTableTopLeft;// mang cac quan bai danh ra tren ban danh cho 3Doi
    vector<Card*> arrGhepDoiOnTableTopRight;// mang cac quan bai danh ra tren ban danh cho 3Doi
    void reloadDoi(int toUser );
    void actionGhepDoi(int fromUser, int toUser, int fromCard, int toCard, int isonhand);
    void loadDoiWhenReturn(int user, string lc);
    void setNoc(int noc);
    void loadHitCardWhenReturn(int posUser, vector<int> arrID);
    void reloadCard(float dt);
    vector<Card*> arrCardFolds;
    vector<Card*> arrCardVong6;
    vector<int> lstIdCardTon;
    bool checkValidHitCard3Doi(int prevCard, int hitCard);
    void showCardTon(int pos, int idCard);
    void showBaiVong6(int pos, int idCard);
    void showCardVictory(int pos, int idCard);
    void loadWhenRejoin(int pos, string lc);
...
private:
	...
	// số bài trên tay
	Sprite *cardBackLeft, *cardBackRight, *cardBackTopLeft, *cardBackBot,*cardBackTopRight, *cardBackNoc,*cardBackBottomRight;
