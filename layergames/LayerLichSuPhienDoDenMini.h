...
#ifndef LayerLichSuPhienDoDenMini_hpp
#define LayerLichSuPhienDoDenMini_hpp
...
class LayerItemLichSuPhienDoDenMiniDo : public Layer{
public:
    virtual bool init();
    CREATE_FUNC(LayerItemLichSuPhienDoDenMiniDo);
...
class LayerItemLichSuPhienDoDenMiniDen : public Layer{
public:
    virtual bool init();
    CREATE_FUNC(LayerItemLichSuPhienDoDenMiniDen);
    void setDatas(int stt,string time,string name,string tai,string xiu,string hoan);
private:
    ImageView* imgBG;
    Text* txtTime;
...
class LayerLichSuPhienDoDenMini : public cocos2d::Layer, public TableViewDataSource,
public TableViewDelegate,public PlayerCallBack
{
public:
    LayerLichSuPhienDoDenMini();
    ~LayerLichSuPhienDoDenMini();
    virtual bool init();
    ...
    CREATE_FUNC(LayerLichSuPhienDoDenMini);
private:
    struct item{
        int stt;
        string time;
...
#endif /* LayerLichSuPhienDoDenMini_hpp */
