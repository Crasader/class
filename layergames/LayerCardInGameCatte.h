...
#ifndef Layer_Card_inGame_Catte___
#define Layer_Card_inGame_Catte___
...
class LayerCardInGameCatte : public Layer
{
public:
	LayerCardInGameCatte();
	~LayerCardInGameCatte();
	bool init();
	CREATE_FUNC(LayerCardInGameCatte);
    ...
    //Catte
    Point getStartPositionCardUserLeft_Hit_Catte();
    Point getStartPositionCardUserRight_Hit_Catte();
    Point getStartPositionCardUserTop_Left_Hit_Catte();
    Point getStartPositionCardUserTop_Right_Hit_Catte();
    Point getStartPositionCardUserBot_Hit_Catte();
    Point getStartPositionCardByPos_Catte(int pos);
    void actionHitCardByCatte(int posUser, vector<int> arrID,int act);
    vector<Card*> arrHitCardOnTableTopLeft;// mang cac quan bai danh ra tren ban danh cho catte
    vector<Card*> arrHitCardOnTableTopRight;// mang cac quan bai danh ra tren ban danh cho catte
    vector<Card*> arrHitCardOnTableLeft;// mang cac quan bai danh ra tren ban danh cho catte
    vector<Card*> arrHitCardOnTableRight;// mang cac quan bai danh ra tren ban danh cho tcatte
    vector<Card*> arrHitCardOnTableBot;// mang cac quan bai danh ra tren ban danh cho catte
    vector<Card*> arrCardFolds;
    vector<Card*> arrCardVong6;
    vector<int> lstIdCardTon;
    bool checkValidHitCardCatte(int prevCard, int hitCard);
    ...
    void refreshListCard(int posUser);
...
private:
	...
	// số bài trên tay
	Sprite *cardBackLeft, *cardBackRight, *cardBackTopLeft, *cardBackBot,*cardBackTopRight;
