...
#ifndef __iCasino_v2__LayerPlayGame3Doi__
#define __iCasino_v2__LayerPlayGame3Doi__
...
class LayerPlayGame3Doi : public Layer, public PlayerCallBack, public NotificationCallBack
{
private:
    //Minh DV
    LogicTienLenMN *logicTienLenMN;//class kiem tra locgic LayerPlayGame3Doi o client
    int demotest;
    ...
    Sprite *bgLoading;
    ProgressTimer *timerLayerPlayGame3Doi;
    Label* labelTimerLayerPlayGame3Doi;
    int timeBaoLayerPlayGame3Doi;//thoi gian bao LayerPlayGame3Doi
    bool isBaoLayerPlayGame3Doi;
    int vipRoom;
    ...
    LayerAvatarInGame3Doi   *layerAvatars;
    LayerCardInGame3Doi     *layerCards;
    ...
    void createLoadingBaoLayerPlayGame3Doi();
    void showLoadingLayerPlayGame3Doi();
    void hideLoadingLayerPlayGame3Doi();
    void updateTimerLayerPlayGame3Doi(float dt);
public:
    LayerPlayGame3Doi();
    ~LayerPlayGame3Doi();
    CREATE_FUNC(LayerPlayGame3Doi);
    ...
    void actionDrawCards(Ref *pSender, Widget::TouchEventType pType);
    ...
    void showBaoLayerPlayGame3Doi();
    void hideBaoLayerPlayGame3Doi();
    // event server
    ...
    void event_EXT_EVENT_CHET_TUNG_NOTIF();
    void event_EXT_EVENT_CHUNG_NOTIF();
    void event_EXT_EVENT_OPEN_CARD_NOTIF();
    void event_EXT_EVENT_STATUS_CARD_NOTIF();
    void event_EXT_EVENT_HIT_BOC_CARD_NOTIF();
    void event_EXT_EVENT_GHEP_DOI_NOTIF();
    void event_EXT_EVENT_HOA();
...
#endif /* defined(__iCasino_v2__LayerPlayGame3Doi__) */
