...
#ifndef AvatarInGame52La_h__
#define AvatarInGame52La_h__
...
class LayerAvatarInGame52La : public Layer
{
public:
	LayerAvatarInGame52La();
	~LayerAvatarInGame52La();

	virtual bool init();
	CREATE_FUNC(LayerAvatarInGame52La);
    ...
    void runTimerBinh(const int& posUser, const float& time);
