...
#ifndef __iCasino_v2__LayerPlayGameCatte__
#define __iCasino_v2__LayerPlayGameCatte__
...
class LayerPlayGameCatte : public Layer, public PlayerCallBack, public NotificationCallBack
{
private:
    //Minh DV
    LogicTienLenMN *logicTienLenMN;//class kiem tra locgic LayerPlayGameCatte o client
    int demotest;
    ...
    Sprite *bgLoading;
    ProgressTimer *timerLayerPlayGameCatte;
    Label* labelTimerLayerPlayGameCatte;
    int timeBaoLayerPlayGameCatte;//thoi gian bao LayerPlayGameCatte
    bool isBaoLayerPlayGameCatte;
    int vipRoom;
    ...
    LayerAvatarInGameCatte   *layerAvatars;
    LayerCardInGameCatte     *layerCards;
    ...
    void createLoadingBaoLayerPlayGameCatte();
    void showLoadingLayerPlayGameCatte();
    void hideLoadingLayerPlayGameCatte();
    void updateTimerLayerPlayGameCatte(float dt);
public:
    LayerPlayGameCatte();
    ~LayerPlayGameCatte();
    CREATE_FUNC(LayerPlayGameCatte);
    ...
    void actionFoldCards(Ref *pSender, Widget::TouchEventType pType);
    ...
    void showBaoLayerPlayGameCatte();
    void hideBaoLayerPlayGameCatte();
    // event server
...
#endif /* defined(__iCasino_v2__LayerPlayGameCatte__) */
