...
#ifndef LayerPlayGameTXMini_hpp
#define LayerPlayGameTXMini_hpp
...
class LayerAnimationTaiXiuMini : public cocos2d::Layer
{
public:
	LayerAnimationTaiXiuMini();
	LayerAnimationTaiXiuMini(Vec2& pos);
	static LayerAnimationTaiXiuMini* createInstance(Vec2& pos);
...
class LayerPlayGameTXMini : public cocos2d::Layer, public PlayerCallBack
{
public:
	LayerPlayGameTXMini();
	~LayerPlayGameTXMini();
    ...
    //moc3-new
    void event_EXT_EVENT_MOBAT_NTF_TXMN();
    void onPopupCallBack(Ref *pSender);
    void event_EXT_EVENT_MOBAT_REGISTER_RESPONSE_TXMN();
    void event_EXT_EVENT_MOBAT_TIME_TXMN();
    void onBtnMoBat(Ref* pSender);
    ...
    void onButtonCai(Ref *sender);
    void showKetQua();
	virtual void onEnter() override;
	virtual void onExit() override;
	CREATE_FUNC(LayerPlayGameTXMini);
private:
...
//moc3-new
    ...
    Layout* pnlKetQua;
    bool isShowKetQua;
    string PATH_TXMN = "design/LayerTaiXiuMini/";
    int fakeHuTX = 0;
    int huTaiXiu = 0;
    string msg = "";
