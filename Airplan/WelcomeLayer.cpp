...
bool WelcomeLayer::init()
{
	...
	do 
	{
		...
		SpriteFrameCache::getInstance()->addSpriteFramesWithFile("airplan/ui/shoot_background.plist");
		SpriteFrameCache::getInstance()->addSpriteFramesWithFile("airplan/ui/shoot.plist");
        SpriteFrameCache::getInstance()->addSpriteFramesWithFile("airplan/ui/sprites.plist");

		auto winSize = Director::getInstance()->getWinSize();

		auto background = Sprite::create("shoot_background3.png");
