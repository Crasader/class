...
LayerMainBottom::LayerMainBottom() : circleAvatar(NULL)
{
}


LayerMainBottom::~LayerMainBottom()
{
    this->unschedule(CC_SCHEDULE_SELECTOR(LayerMainBottom::scheduleUpdateInfo));
    this->unschedule(schedule_selector(LayerMainBottom::onScheduleThongBao));
    GameServer::getSingleton().removeListeners(this);
}

bool LayerMainBottom::init()
{
    if (!Layer::init())
    {
        return false;
    ...
    if (SceneManager::getSingleton().getIsFlagStore()){
        txtName = dynamic_cast<Text*>(rootNode->getChildByName("lblName"));
        txtLevel = dynamic_cast<Text*>(rootNode->getChildByName("lblLevel"));
        txtMoney = dynamic_cast<Text*>(rootNode->getChildByName("lblMoney"));
        this->lblMoneyVirtual = dynamic_cast<Text*>(rootNode->getChildByName("lblMoneyVirtual"));
        ...
        if (SceneManager::getSingleton().getGameVersion() == GameVersion::p2){
            ...
            btnBaoDanh->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onGotoBaoDanh, this));
        ...
        if (btnAvatar){
            btnAvatar->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onButtonUserInfo, this));
        ...
        if (SceneManager::getSingleton().getGameVersion() == GameVersion::p1){
            ...
            if (this->btnUngTien){
                this->btnUngTien->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onButtonUngTien, this));
        ...
        if (img != NULL)
        {
            ...
            this->circleAvatar->setClickCallBack(CC_CALLBACK_0(LayerMainBottom::onButtonAvatar, this));
        ...
        if (btnCharge != NULL){
            btnCharge->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onButtonCharge, this));
        ...
        if (btnChuyenTien != NULL){
            btnChuyenTien->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onButtonChuyenTien, this));
        ...
        if (btnDoiThuong != NULL){
            btnDoiThuong->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onButtonDoiThuong, this));
        ...
        //
        this->scheduleOnce(CC_SCHEDULE_SELECTOR(LayerMainBottom::scheduleUpdateInfo), 1);
    ...
    if (this->btnPoker){
        ...
        this->btnPoker->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onButtonMiniGame, this));
    ...
    this->btnTaiXiu->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onButtonMiniGame, this));
    ...
    if (this->btnSapNgua){
        ...
        this->btnSapNgua->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onButtonMiniGame, this));
    ...
    if (this->btnCaoThap){
        ...
        this->btnCaoThap->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onButtonMiniGame, this));
    ...
    if (this->btnVongQuay){
        ...
        this->btnVongQuay->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onButtonMiniGame, this));
    ...
    if (btnSuKien){
        btnSuKien->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onButtonSuKien, this));
    ...
    if (btnNapGold){
        btnNapGold->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onBtnNapGold, this));
    ...
    if (btnNapSilver){
        btnNapSilver->addClickEventListener(CC_CALLBACK_1(LayerMainBottom::onBtnNapSilver, this));
    ...
    this->schedule(schedule_selector(LayerMainBottom::onScheduleTX),1);
    ...
    this->schedule(schedule_selector(LayerMainBottom::onScheduleThongBao),1);
    //GameServer::getSingleton().addListeners(this);
    //
    //	if (dataManager.getAppConfig().isHideBilling){
    //		Label* versionLabel = Label::createWithTTF("", kNormalFont, 50);
...
void LayerMainBottom::hideTXMenu(){
    if (SceneManager::getSingleton().getIsFlagStore()){
        return;
    }
...
void LayerMainBottom::showTXMenu(){
//    if (SceneManager::getSingleton().isNagaWin){
//        this->hideTXMenu();
//        return;
//    }
    this->scheduleOnce(schedule_selector(LayerMainBottom::delayTXMenu),2);
}
void LayerMainBottom::delayTXMenu(float dt){
    this->btnTaiXiu->setVisible(false);
    this->menu->setVisible(true);
    this->menu->addListenerServer();
}
void LayerMainBottom::reloadLang(){
    this->imgDoiThuong->loadTexture(IMAGE_PATH+SceneManager::getSingleton().getFolderLang()+"imgdoiwing.png");
    this->txtTX->setString(dataManager.GetSysString(969));
    this->txtPK->setString(dataManager.GetSysString(859));
    this->txtDD->setString(dataManager.GetSysString(970));
...
void LayerMainBottom::onScheduleTX(float dt){
    if (this->timerTX>0){
        this->timerTX-=1;
...
void LayerMainBottom::onEnter()
{
    Layer::onEnter();
    //    auto dispatcher = Director::getInstance()->getEventDispatcher();
    //    auto listener = EventListenerTouchOneByOne::create();
    //    listener->setSwallowTouches(true);
    //    listener->onTouchBegan = CC_CALLBACK_2(LayerMainBottom::onTouchBegan, this);
    //    dispatcher->addEventListenerWithSceneGraphPriority(listener, this);
    //    _touchListener = listener;
    
    GameServer::getSingleton().addListeners(this);
}
bool LayerMainBottom::onTouchBegan(cocos2d::Touch *pTouch, cocos2d::Event *pEvent){
...
void LayerMainBottom::onExit()
{
    Layer::onExit();
    auto dispatcher = Director::getInstance()->getEventDispatcher();
    dispatcher->removeEventListener(_touchListener);
    //GameServer::getSingleton().removeListeners(this);
    this->unschedule(schedule_selector(LayerMainBottom::delayTXMenu));

    Layer::onExit();
}
void LayerMainBottom::onBtnNapGold(Ref* pSender){
...
void LayerMainBottom::onBtnNapSilver(Ref* pSender){
    auto _currScene = Director::getInstance()->getRunningScene();
    if (!_currScene) return;
...
void LayerMainBottom::onScheduleThongBao(float dt)
{
...
void LayerMainBottom::onButtonSuKien(Ref* pSender){
    //    auto _currScene = Director::getInstance()->getRunningScene();
    //    if (!_currScene) return;
    //
...
void LayerMainBottom::onButtonUngTien(Ref* pSender){
    auto _currScene = Director::getInstance()->getRunningScene();
    if (!_currScene) return;
...
void LayerMainBottom::onButtonCharge(Ref* pSender)
{
...
void LayerMainBottom::onButtonMiniGame(Ref* pSender){
...
void LayerMainBottom::onGotoBaoDanh(Ref* pSender){
...
void LayerMainBottom::onButtonDoiThuong(Ref* pSender)
{
    // 	SceneMain* _parent = (SceneMain*)this->getParent();
    // 	if (_parent != NULL){
...
void LayerMainBottom::onButtonChuyenTien(Ref* pSender)
{
...
void LayerMainBottom::onButtonUserInfo(Ref* pSender)
{
...
void LayerMainBottom::loadAllDatas()
{
...
void LayerMainBottom::OnSmartFoxUserVariableUpdate(unsigned long long ptrContext, boost::shared_ptr<BaseEvent> ptrEvent)
{
...
void LayerMainBottom::OnExtensionResponse(unsigned long long ptrContext, boost::shared_ptr<BaseEvent> ptrEvent)
{
...
void LayerMainBottom::scheduleUpdateInfo(float dt)
{
    loadAllDatas();
}

void LayerMainBottom::onButtonAvatar()
{
    auto _currScene = Director::getInstance()->getRunningScene();
    if (!_currScene) return ;
    LayerPopupProfile* profile = LayerPopupProfile::create();
